...
void relocate(char *dp)
{
	...
	iki_vhdl_file_variable_register(dp + 875256);
	iki_vhdl_file_variable_register(dp + 875312);
...

{
	...
	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1145088, dp + 1143680, 0, 3, 0, 3, 4, 1);
